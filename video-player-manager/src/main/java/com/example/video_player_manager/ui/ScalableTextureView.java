package com.example.video_player_manager.ui;
...
public abstract class ScalableTextureView extends TextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (SHOW_LOGS) Logger.v(TAG, "onMeasure, mContentWidth" + mContentWidth + ", mContentHeight" + mContentHeight);
    ...
    public void updateTextureViewSize() {
        if (SHOW_LOGS) Logger.v(TAG, ">> updateTexutureViewSize");
        if (mContentWidth == null || mContentHeight == null) {
